<head>
    ...
    <title>Формирование отчёта — Продажи</title>
                ...
                <div class="space-y-3">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center space-x-2 p-2 hover:bg-gray-50 rounded cursor-pointer">
                            ...
                            <span class="text-gray-700">Звуковое оборудование</span>
                        </div>
                        ...
                        <div class="flex items-center space-x-2 p-2 hover:bg-gray-50 rounded cursor-pointer">
                            ...
                            <span class="text-gray-700">Световое оборудование</span>
                        </div>
                        ...
                        <div class="flex items-center space-x-2 p-2 hover:bg-gray-50 rounded cursor-pointer">
                            ...
                            <span class="text-gray-700">Видеооборудование</span>
                        </div>
                        ...
                        <div class="flex items-center space-x-2 p-2 hover:bg-gray-50 rounded cursor-pointer">
                            ...
                            <span class="text-gray-700">Расходники</span>
                        </div>
                        ...
                        <div class="flex items-center space-x-2 p-2 hover:bg-gray-50 rounded cursor-pointer">
                            ...
                            <span class="text-gray-700">Аксессуары</span>
                        </div>
                        ...
                        <div class="flex items-center space-x-2 p-2 hover:bg-gray-50 rounded cursor-pointer">
                            ...
                            <span class="text-gray-700">Сценические конструкции</span>
                        </div>
                        ...
                        <div class="flex items-center space-x-2 p-2 hover:bg-gray-50 rounded cursor-pointer">
                            ...
                            <span class="text-gray-700">Монтажное оборудование</span>
                        </div>
                    </div>
                </div>
            </div>
