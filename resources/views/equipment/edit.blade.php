            ...
            <div class="mb-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="length_cm" id="length_cm" value="{{ $specifications['length_cm'] ?? '' }}" class="mt-1 block w-full border-gray-300 rounded-md text-sm" oninput="this.value = this.value.replace(/[a-zA-Zа-яА-Я]/g, '')">
                    </div>
                    <div>
                        <label for="width_cm" class="block text-xs font-medium text-gray-500">Ширина (см)</label>
                        <input type="text" name="width_cm" id="width_cm" value="{{ $specifications['width_cm'] ?? '' }}" class="mt-1 block w-full border-gray-300 rounded-md text-sm" oninput="this.value = this.value.replace(/[a-zA-Zа-яА-Я]/g, '')">
                    </div>
                    <div>
                        <label for="height_cm" class="block text-xs font-medium text-gray-500">Высота (см)</label>
                        <input type="text" name="height_cm" id="height_cm" value="{{ $specifications['height_cm'] ?? '' }}" class="mt-1 block w-full border-gray-300 rounded-md text-sm" oninput="this.value = this.value.replace(/[a-zA-Zа-яА-Я]/g, '')">
                    </div>
                    <div>
                        <label for="weight_kg" class="block text-xs font-medium text-gray-500">Вес (кг)</label>
                        <input type="text" name="weight_kg" id="weight_kg" value="{{ $specifications['weight_kg'] ?? '' }}" class="mt-1 block w-full border-gray-300 rounded-md text-sm" oninput="this.value = this.value.replace(/[a-zA-Zа-яА-Я]/g, '')">
                    </div>
                    <div>
                        <label for="power_w" class="block text-xs font-medium text-gray-500">Мощность (Вт)</label>
                        <input type="text" name="power_w" id="power_w" value="{{ $specifications['power_w'] ?? '' }}" class="mt-1 block w-full border-gray-300 rounded-md text-sm" oninput="this.value = this.value.replace(/[a-zA-Zа-яА-Я]/g, '')">
                    </div>
                    <div>
                        <label for="current_a" class="block text-xs font-medium text-gray-500">Ток (А)</label>
                        <input type="text" name="current_a" id="current_a" value="{{ $specifications['current_a'] ?? '' }}" class="mt-1 block w-full border-gray-300 rounded-md text-sm" oninput="this.value = this.value.replace(/[a-zA-Zа-яА-Я]/g, '')">
                    </div>
                </div>
            </div>
