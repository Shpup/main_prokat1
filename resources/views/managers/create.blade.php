...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="container mx-auto p-6">
        <h1 class="text-2xl font-semibold text-gray-800 mb-6">Добавить сотрудника</h1>
        <form action="{{ route('managers.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow-md max-w-lg">
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('managers') }}" class="bg-gray-300 text-gray-800 py-2 px-4 rounded-md hover:bg-gray-400">Отмена</a>
